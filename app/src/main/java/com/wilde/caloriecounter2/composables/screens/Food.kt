        ...
        Column(
            ...
            FoodRow {
                ...
                FoodField(
                    ...
                    value = servingSize,
                    onValueChange = {
                        foodViewModel.product.nutriments.perServing.servingSize.update(
                            it
                        )
                    },
                )
            ...
            FoodRow {
                ...
                FoodField(
                    ...
                    value = saturatedFat,
                    onValueChange = {
                        foodViewModel.product.nutriments.perServing.saturatedFat.update(
                            it
                        )
                    },
                )
            ...
            FoodRow {
                ...
                FoodField(
                    ...
                    value = cholesterol,
                    onValueChange = {
                        foodViewModel.product.nutriments.perServing.cholesterol.update(
                            it
                        )
                    },
                )
